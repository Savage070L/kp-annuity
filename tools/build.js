...
function kit() {
  ...
  return [
    ...
    '      if (calc.mode === "free" && calc.savings - need > 100000) {',
    '        var mn = run(Object.assign({}, input, { savings: need, contribution: 0 }), true);',
    '        if (mn && mn.ok) calc.minimal = { premium: mn.premium, first: mn.first, rest: calc.savings - need };',
    '      }',
